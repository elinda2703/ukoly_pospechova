...
try:
    with open(r"vstup.sv", encoding="utf-8") as csvinfile, open(r"vystup_7denni.csv", "w", encoding="utf-8", newline="") as csvoutfile_den, open(r"vystup_rok.csv", "w", encoding="utf-8", newline="") as csvoutfile_rok:
        ...
        print(
            f"Maximální průtok nastal {max_prutok[2]}.{max_prutok[1]}.{max_prutok[0]}, tento průtok byl {max_prutok[3]}.")
        print(
            f"Minimální průtok nastal {min_prutok[2]}.{min_prutok[1]}.{min_prutok[0]}, tento průtok byl {min_prutok[3]}.")
